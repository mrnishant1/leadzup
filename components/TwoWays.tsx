      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            ...
            Private DMs convert that authority into actual conversations with
            buyers. Leadzup handles both.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg border-2 border-gray-200 p-8 relative">
            ...
            <div className="mt-8 mb-6">
              ...
              <p className="text-gray-700 mb-6">
                Engage in Reddit threads and mention your product to build brand
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  AI finds relevant discussions to join
                </span>
              </div>
              <div className="flex items-center gap-2">
                <svg
                ...
                <span className="text-gray-700">
                  Get helpful AI-assisted replies
                </span>
              </div>
              <div className="flex items-center gap-2">
                <svg
          ...
          <div className="bg-white rounded-lg border-2 border-gray-200 p-8 relative">
            ...
            <div className="mt-8 mb-6">
              ...
              <p className="text-gray-700 mb-6">
                Automatically send targeted messages to dozens of Reddit users
                at once and close deals.
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  Bulk automate DMs without detection
                </span>
              </div>
              <div className="flex items-center gap-2">
                <svg
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  Find leads via targeting specific threads or subreddits
                </span>
              </div>
            </div>
